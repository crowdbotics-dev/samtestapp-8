"""
Django settings for samtestapp_8 project.
...
ROOT_URLCONF = 'samtestapp_8.urls'
...
WSGI_APPLICATION = 'samtestapp_8.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "samTestApp Support <support@samtestapp-8.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samtestapp_8 API",
    "DESCRIPTION": "API documentation for samtestapp_8 App",
    "VERSION": "v1",
}
